...
urlpatterns: list[URLPattern] = [
    ...
    path("org/analytics/", OrgRevenueAnalyticsView.as_view(), name="org-revenue-analytics"),
    ...
    # stripe connect
    path("connect/accounts/", ConnectedAccountView.as_view(), name="connected-account"),
    path("connect/payouts/", PayoutCreateView.as_view(), name="payout-create"),
